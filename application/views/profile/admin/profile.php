                                ...
                                <div class="col-xs-12 col-md-4" id="ubahpassword">
                                    <form method="post" action="<?= base_url() . 'profile/ubah_password'; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="password" id="pwd" class="form-control" name="passbaru" placeholder="Password Baru" data-toggle="password" value="" disabled required>
                                                <div class="input-group-append">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="password" id="pwd1" class="form-control" name="konfpass" placeholder="Konfirmasi Password" data-toggle="password" value="" disabled required>
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <i class="fa fa-eye" id="eye"></i>
                                                    </div>
