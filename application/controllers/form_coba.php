...
class Kepala extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->helper('file', 'email');
    }

    public function index()
    {
        $this->load->view('form_coba');
    }
    ...
    function tambah_kepala()
    {
        ...
        if ($cek_nip > 0) {
            ...
            $config = [
                ...
                'smtp_pass'   => 'Admin1999',  // Password gmail
                'smtp_crypto' => 'ssl',
                'smtp_port'   => 465,
                'crlf'    => "\r\n",
                'newline' => "\r\n"
            ...
            $this->email->from('no-reply@lenovela.com');

            // Email penerima
            $this->email->to('fmaurtino@gmail.com'); // Ganti dengan email tujuan

            // Subject email
            $this->email->subject('[PENDAFTARAN] Akun Kepala | LENOVELA');

            // Isi email
            $this->email->message("Halo, <?= $nama; ?> <br> Selamat Akun Anda Sudah Terdaftar.<br><br> Dibawah adalah detail akun Anda : <br> NIP: <?= $nip; ?> <br><br> Password : <?= $password; ?> <br><br> Akun Anda telah aktif dan dapat digunakan.");
